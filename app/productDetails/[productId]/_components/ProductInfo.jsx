...
export default function ProductInfo({product}) {
  return (
    <div>
      ...
      <p className='text-[11px] text-gray-500 flex gap-2 mt-2 items-center'> { product?.attributes?.instantDelivery ? <BadgeCheck className='w-4 h-4 text-gray-500'/> : <AlertOctagon/>}Eligible For Instant Delivery</p>
